...
namespace BulkyBook.DataAccess.Migrations
{
    ...
    [Migration("20231011184025_couponfieldsaddednull")]
    partial class couponfieldsaddednull
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BulkyBook.Models.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double?>("maxRedeemableAmt")
                        .HasColumnType("float");

                    b.Property<double?>("minimumCartAmount")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("BulkyBook.Models.Offer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBook.Models.ProductReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBook.Models.Wallet", b =>
                {
            ...
            modelBuilder.Entity("BulkyBook.Models.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBook.Models.OrderHeader", b =>
                {
                    ...
                    b.HasOne("BulkyBook.Models.Coupon", "Coupon")
                        .WithMany()
            ...
            modelBuilder.Entity("BulkyBook.Models.WalletTransaction", b =>
                {
                    ...
                    b.HasOne("BulkyBook.Models.Wallet", "Wallet")
                        .WithMany()
